...
function cargarProductosCarrito() {
    if(productosEnCarrito && productosEnCarrito.length > 0){
        ...
        contenedorCarritoProductos.innerHTML = " "//para que siempre este vacio de entrada
...
function vaciarCarrito() {
    ...
    Swal.fire({
        title: '¿Querés borrar todos los productos de tu carrito?',
        showDenyButton: true,
        customClass:{
            confirmButton: 'custom-yes-button',
            denyButton: 'custom-no-button',
        },
        confirmButtonText: 'Si',color:'black',
        denyButtonText: `No`,
    }).then((result) => {
